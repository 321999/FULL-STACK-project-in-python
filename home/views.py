...
def samaan(request):
    ...
    text="""
        ...
        """
    return render(request,"product/index.html",context={"loyal":loyal,"text":text,"title":"main page","name":name,"filesize":to_findFileSize})

def contact(request):

    return render(request,"product/contact.html",context={'title':'contact'})

def about(request):
    return render(request,"product/about.html",context={'title':'about me'})
